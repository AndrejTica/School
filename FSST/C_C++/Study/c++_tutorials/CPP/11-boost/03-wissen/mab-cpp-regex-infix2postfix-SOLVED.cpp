...
int main(){
	...
	boost::regex rgx("[ ]*([0-9]*)[ ]*(\\+|\\*)[ ]*([0-9]*)[ ]*");
	
	cout <<"infix:  <" << s1 << ">" << endl;
	cout <<"postfix:<" << boost::regex_replace(s1,rgx,"$1 $3 $2")<< ">" << endl<<endl;

	cout <<"infix:  <" << s2 << ">" << endl;
	cout <<"postfix:<" << boost::regex_replace(s2,rgx,"$1 $3 $2")<< ">" << endl<<endl;

	cout <<"infix:  <" << s3 << ">" << endl;
	cout <<"postfix:<" << boost::regex_replace(s3,rgx,"$1 $3 $2")<< ">" << endl<<endl;
