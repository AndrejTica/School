...
public class DialDemo3 extends JFrame {
	private JPanel panelFIFO;
	private JPanel panelProducer;
	private JPanel panelConsumer;  // JFreeChart
    ...
    public DialDemo3(String title) {
        ...
        getContentPane().add(getPanelProducer(), BorderLayout.SOUTH);
        getContentPane().add(getPanelFIFO(), BorderLayout.NORTH);
    }
	...
	private JPanel getPanelFIFO() {
		if (panelFIFO == null) {
			panelFIFO = new JPanel();
		}
		return panelFIFO;
	}
