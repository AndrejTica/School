...
-- Aufgabe 2:
-- ---------
-- Installieren Sie auf ihrem Server die datenbank is_speisen mit
-- dem folg. SQL-Script.

-- Aufgabe 3:
-- ---------
-- Verschaffen Sie sich einen Überblick zur Datenbank is_speisen, indem
-- Sie ein ER-Diagramm erstellen.
--
-- Tipp: Verwende phpmyadmin (Design) oder mysql-workbench (database->reverse-engineering)
--
-- Aufgabe 4:
-- ---------
-- Geben Sie zu jedem SELECT-Befehl eine kurze prägnante, textuelle/mündliche 
