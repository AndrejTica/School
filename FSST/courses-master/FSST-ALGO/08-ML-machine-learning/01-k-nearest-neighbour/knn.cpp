...
vector<distance_index_t> knn(const vector<height_weight_t> &data, double query, int k) {

  // priority queue
  priority_queue<distance_index_t, vector<distance_index_t>,std::greater<distance_index_t>>
...
*/
  ...
  best_guess /= k;
  cout << "Best guess for 152.4 cm is " << best_guess << endl;
  cout << endl;
  return 0;
}
...
#Column 1 : likes pineapple
  ''' clf_data = [[ 22, 1 ], [ 23, 1 ], [ 21, 1 ], [ 18, 1 ], [ 19, 1 ],
...
#Given the data we have, does a 33 year old like pineapples on their pizza ?
    clf_query = [33] clf_k_nearest_neighbors,
clf_prediction = knn(clf_data, clf_query, k = 3,
