...
1. Create project: 03-JAVA-FUNCTION
2. Create package myalgos;
3. Create class MyAlgos in package myalgos
4. Create Test-Programs TXX_Xxxxx.java (see below) to test your functions in MyAlgos
