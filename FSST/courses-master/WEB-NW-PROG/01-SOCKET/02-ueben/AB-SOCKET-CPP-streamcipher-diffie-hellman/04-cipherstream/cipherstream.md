# Lab: Write class CipherStream - A stream with encryption
...
- description:![./streamcipher.png](./streamcipher.png)

# 2. Lab: create  class CipherStream
...
* Lab: **Create** class **CipherStream** so that the following code works.
...
your class CipherStream works correct, if you see "HalloHallo" above

TESTING plain2cipher() and cipher2plain() which are used for  communication ...
client -> server:
   <MESSAGE-01>
   <MESSAGE-02>
   <MESSAGE-03>
encrypted and transfered messages: 
�����, �
   ζ�/��6�ճ
   Jk0`ގ�K>�
server -> client:
