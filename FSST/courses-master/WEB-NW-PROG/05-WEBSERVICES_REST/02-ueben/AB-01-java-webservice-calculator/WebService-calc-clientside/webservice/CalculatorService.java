 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://webservice/", wsdlLocation = "http://192.168.2.15:8080/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://webservice/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.2.15:8080/calculator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://webservice/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice/", "CalculatorPort"), Calculator.class, features);
    }
