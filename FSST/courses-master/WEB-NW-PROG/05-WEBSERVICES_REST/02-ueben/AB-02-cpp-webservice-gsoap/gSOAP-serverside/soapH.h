...
inline struct ns__sqrtResponse * soap_new_req_ns__sqrtResponse(struct soap *soap, double result) { struct ns__sqrtResponse *_p = soap_instantiate_ns__sqrtResponse(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns__sqrtResponse(soap, _p); _p->result = result; } return _p; }
...
inline struct ns__subResponse * soap_new_req_ns__subResponse(struct soap *soap, double result) { struct ns__subResponse *_p = soap_instantiate_ns__subResponse(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns__subResponse(soap, _p); _p->result = result; } return _p; }
...
inline struct ns__addResponse * soap_new_req_ns__addResponse(struct soap *soap, double result) { struct ns__addResponse *_p = soap_instantiate_ns__addResponse(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns__addResponse(soap, _p); _p->result = result; } return _p; }
